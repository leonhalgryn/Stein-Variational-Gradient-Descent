...
#NOTE: This script might cause issues due to uninstalled dependencies. If errors arise, see the Google Colab notebook for the LunarLander experiments
...
if __name__ == "__main__":
       ...
       plt.legend()
       plt.title("LunarLander results")
       plt.xlabel("Episodes")
       plt.ylabel("Average reward across agents")
       plt.savefig("./figures/lunar_lander.png")
       plt.show()